...
- `target/cyufriends-reload-paper-1.0.8.jar`
- `target/cyufriends-reload-paper-1.0.8-legacy-all.jar`
- `target/cyufriends-reload-paper-1.0.8-api.jar`
- `target/cyufriends-reload-folia-1.0.8.jar`
...
```bash
git checkout -b fix/v1.0.8-hotfix v1.0.8
```
